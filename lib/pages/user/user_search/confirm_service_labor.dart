...
class _Confirm_service_laborState extends State<Confirm_service_labor> {
  ...
  //       "http://103.212.181.47/agriser_work/add_schedule_service.php?isAdd=true&id_service=$id_service&phone_user=$phone_user&phone_provider=$phone_provider&date_work=$date_work&count_field=$count_field&total_price=$total_price&map_lat_work=$map_lat_work&map_long_work=$map_long_work&type_service=$type_service");
