...
class Record_schedule_contact_labor extends StatefulWidget {
  const Record_schedule_contact_labor({Key? key}) : super(key: key);

  @override
  State<Record_schedule_contact_labor> createState() =>
      _Record_schedule_contact_laborState();
}

class _Record_schedule_contact_laborState
    extends State<Record_schedule_contact_labor> {
