...
class _User_record_contactState extends State<User_record_contact> {
              ...
              child: InkWell(
                onTap: () async {
                  ...
                  if (search_service[index]["type_service"] == "car") {
                    ...
                    MaterialPageRoute route = MaterialPageRoute(
                        builder: (context) => Record_schedule_contact_labor());
                    Navigator.push(context, route);
                  }
                },
                child: Row(
  ...
  Loadservice() async {
    ...
    final response = await dio.get(
        "http://103.212.181.47/agriser_work/search_record_schedule_service_car_ucp.php?isAdd=true&phone_user=$phone_user");
