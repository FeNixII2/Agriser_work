...
class Data_schedule_contact_labor extends StatefulWidget {
  const Data_schedule_contact_labor({Key? key}) : super(key: key);

  @override
  State<Data_schedule_contact_labor> createState() =>
      _Data_schedule_contact_laborState();
}

class _Data_schedule_contact_laborState
    extends State<Data_schedule_contact_labor> {
  ...
  late String type, info_choice, prices, total_choice, image1, image2;
  ...
  late String check_carlabor, rating, comment;
  late String load = "0";
    ...
    if (response.statusCode == 200) {
      ...
      for (var map in jsonData) {
        ...
        setState(() {
          ...
          check_carlabor = datauser.type_service;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            Text("รายละเอียดการนัดหมาย", style: GoogleFonts.mitr(fontSize: 18)),
