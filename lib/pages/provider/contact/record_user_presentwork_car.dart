...
class Record_user_presentwork_car extends StatefulWidget {
  const Record_user_presentwork_car({Key? key}) : super(key: key);

  @override
  State<Record_user_presentwork_car> createState() =>
      _Record_user_presentwork_carState();
}

class _Record_user_presentwork_carState
    extends State<Record_user_presentwork_car> {
  ...
  Future<Null> findData() async {
    ...
    setState(() {
      ...
      LoadRecord_user_presentwork_car();
