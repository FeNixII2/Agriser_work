...
class Details_user_presentwork_labor extends StatefulWidget {
  const Details_user_presentwork_labor({Key? key}) : super(key: key);

  @override
  State<Details_user_presentwork_labor> createState() =>
      _Details_user_presentwork_laborState();
}

class _Details_user_presentwork_laborState
    extends State<Details_user_presentwork_labor> {
  ...
  Future<Null> findData() async {
    ...
    setState(() {
      ...
      LoadDetails_user_presentwork_labor();

      LoadData_user();
    });
  }

  Future LoadDetails_user_presentwork_labor() async {
    var url =
