...
import 'package:agriser_work/pages/provider/contact/record_user_presentwork_car.dart';
import 'package:agriser_work/pages/provider/contact/record_user_presentwork_labor.dart';
...
class Provider_record_contact extends StatefulWidget {
  const Provider_record_contact({Key? key}) : super(key: key);

  @override
  State<Provider_record_contact> createState() =>
      _Provider_record_contactState();
}

class _Provider_record_contactState extends State<Provider_record_contact> {
  List search_service = [];

  late String name_provider;
  late String phone_provider;
  late String status, show;
                ...
                onTap: () async {
                  ...
                  if (search_service[index]["type_presentwork"] == "car") {
                    MaterialPageRoute route = MaterialPageRoute(
                        builder: (context) => Record_user_presentwork_car());
                    Navigator.push(context, route);
                  } else if (search_service[index]["type_presentwork"] ==
                      "labor") {
                    MaterialPageRoute route = MaterialPageRoute(
                        builder: (context) => Record_user_presentwork_labor());
                    Navigator.push(context, route);
                  }
                },
                child: Row(
  ...
  Loadservice() async {
    ...
    final response = await dio.get(
        "http://103.212.181.47/agriser_work/search_record_schedule_presentwork_pcu.php?isAdd=true&phone_provider=$phone_provider");
